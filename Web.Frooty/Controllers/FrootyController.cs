...
{
    public class FrootyController : Controller
    {
        //
        // GET: /Frooty/
            ...
            try
            {
                ...
                if (result != null)
                {
                    ...
                    if (result.changePassWord == "1")
                    {
                        ...
                        Response.Cookies.Add(new HttpCookie("acai-user", Security.Encrypt(result.id_partners.ToString())));
        ...
        public JsonResult logout() {
            try {
                ...
                var c = new HttpCookie("acai-user");
                c.Expires = DateTime.Now.AddDays(-1);
                Response.Cookies.Add(c);

                var a = new HttpCookie("shop-acai");
