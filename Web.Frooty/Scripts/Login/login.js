    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.success) {
                ...
                $("#controler").append('<a class="heavy85 partner" href="#" data-toggle="modal" data-target="#LoginModal"><i class="glyphicon glyphicon-user"></i> LOGIN</a>');
