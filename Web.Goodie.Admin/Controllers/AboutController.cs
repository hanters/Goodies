    ...
    public class AboutController : WebPageBase
    {
        ...
        public JsonResult SelectAbout()
        {
            try
            {
                ...
                var result = (from a in db.tb_about_goodie_time
                              select new
                              {
                                  a.id_About,
                                  a.aba,
        ...
        [HttpPost]
        [ValidateInput(false)]
        public JsonResult CadAbout(tb_about_goodie_time dados)
        {
            try
            {
                frootyacai_siteEntities db = new frootyacai_siteEntities();

                dados.url = this.RemoverAcentos(dados.aba).Replace(" ", "-").Replace("  ", "-");
                db.tb_about_goodie_time.Add(dados);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateInput(false)]
        public JsonResult UpDateAbout(tb_about_goodie_time dados)
        {
            try
            {
                ...
                var result = db.tb_about_goodie_time.FirstOrDefault(a => a.id_About == idAbout);
        ...
        [HttpPost]
        public JsonResult EditAbout(tb_about_goodie_time dados)
        {
            try
            {
                var db = new frootyacai_siteEntities();
