        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.success == 1) {
                    ...
                    $("#email").val('');
                    $("#controler").html('');
                    $("#controler").html('<span><i class="glyphicon glyphicon-user"></i></span> <span id="btn-logout"> LOGOUT</span>');
...
function logout(obj) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data.success) {
                $("#controler").html('');
                $("#controler").html('<span><i class="glyphicon glyphicon-user"></i></span><span id="lnk-modal">  LOGIN</span>');         
                $("#lnk-modal").on('click', function () {
                    $("#recoveryform").hide();
                    $("#TrocarSenhaForm").hide();
                    $("#loginform").show();
